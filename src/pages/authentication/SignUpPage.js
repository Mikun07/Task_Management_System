...
const roleValues = RolesWithAdmin.map((role) => role.value);
...
const SignUpPage = () => {
    ...
    return (_jsx("div", { className: "w-screen h-screen bg-primary bg-opacity-[12%]", children: _jsx("div", { className: "flex justify-center w-full h-full items-center", children: _jsx("div", { className: "lg:border-2 bg-white p-5 lg:shadow-sm lg:h-[480px] h-full flex flex-col justify-center lg:rounded-md lg:w-[460px] md:w[350px] w-full", children: _jsxs(FormProvider, { ...methods, children: [_jsx("h1", { className: "font-semibold flex justify-center", children: "Sign Up" }), _jsxs("form", { onSubmit: methods.handleSubmit(handleSignUp), className: "flex flex-col gap-y-4 mt-4", children: [_jsxs("div", { className: "grid grid-cols-2 gap-4", children: [_jsx(NameInput, { name: "email", type: "email", label: "Email Address", error: methods.formState.errors.email }), _jsx(NameInput, { name: "username", type: "text", label: "Username", error: methods.formState.errors.username }), _jsx(NameInput, { name: "first_name", type: "text", label: "First Name", error: methods.formState.errors.first_name }), _jsx(NameInput, { name: "last_name", type: "text", label: "Last Name", error: methods.formState.errors.last_name }), _jsx(NameInput, { name: "phone_number", type: "text", label: "Phone Number", error: methods.formState.errors.phone_number }), _jsx(PasswordInput, { name: "password", label: "Password", error: methods.formState.errors.password }), _jsx(SelectInput, { options: roleOptions, control: methods.control, handleChange: handleRoleChange, label: "Role", title: "Select Role...." })] }), _jsx("div", { className: "flex flex-col gap-1", children: _jsxs("p", { className: "capitalize flex justify-center text-[14px]", children: ["I already have an account", _jsxs("b", { onClick: handleLogin, className: "hover:text-primary cursor-pointer", children: [" ", "Login"] })] }) }), _jsx(Button, { type: "submit", loading: isLoading, disabled: methods.formState.isSubmitting || !methods.formState.isValid // Disable button if form is invalid
                                    , children: "Register" })] })] }) }) }) }));
};
