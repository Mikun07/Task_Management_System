...
const TaskPage = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "flex flex-row  justify-between", children: [_jsxs("div", { className: "flex gap-3 my-1", children: [_jsx("button", { className: "bg-white p-1 px-4 rounded-md font-bold items-center justify-center flex text-primaryGray", onClick: goBack, children: _jsx(AiOutlineLeft, { size: 20 }) }), _jsxs("div", { children: [_jsx(DisplayButton, { onClick: toggleModal, title: "Add Task", image: _jsx(AiOutlinePlus, {}) }), _jsxs(Modal, { isOpen: modalOpen, onClose: toggleModal, children: [_jsxs("div", { className: "flex items-center justify-between mb-8", children: [_jsx("h2", { className: "text-xl font-semibold", children: "Create Task" }), _jsx("button", { className: "bg-primary text-white py-2 px-4 rounded", onClick: toggleModal, children: "Close" })] }), _jsx(CreateTaskForm, { onClose: toggleModal })] })] })] }), _jsxs("div", { children: [_jsx(DisplayButton, { onClick: toggleModalInvite, title: "Invite" }), _jsxs(Modal, { isOpen: modalInvite, onClose: toggleModalInvite, children: [_jsx("div", { className: "flex items-center justify-center mb-6", children: _jsx("h1", { className: "text-primaryGray font-bold ", children: "Invite a Team Member" }) }), _jsx(InviteForm, { onClose: toggleModalInvite })] })] })] }), _jsx(DragDropContext, { onDragStart: onDragStart, onDragEnd: onDragEnd, children: _jsx("div", { className: "flex gap-3", children: columns.map((column, index) => (_jsx(TaskColumn, { title: column.title, bgColor: column.bgColor, tasks: column.tasks, columnId: column.columnId }, index))) }) })] }));
};
